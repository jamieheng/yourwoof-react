...
// DeleteModal
  ...
  const closeDeleteModal = () => {
    ...
    const editUser = (id) => {
      ...
      axios.put(`http://localhost:3001/user/${id}`, updatedUser)
        .then(response => {
                  ...
                  >
                    ...
                    <div className='w-full flex flex-row justify-center items-center p-4'>
                      ...
                      <div className='w-full flex flex-row justify-end items-center p-4'>
                            ...
                            <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => {editUser(editModalUserId); closeEditModal()}} >
                              <p>Save Changes</p>
                            </button>
                  ...
                  >
                    <form action="" className='flex flex-col justify-center items-center w-full'>
                      ...
                      <div className='w-full flex flex-row justify-end items-center p-4'>
                            ...
                            <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { deleteUser(deleteModalUserId); closeDeleteModal(); }}>
                              <p>Yes</p>
                            </button>
