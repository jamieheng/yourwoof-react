...
const SurrenderTable = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/surrender')
    .then(response => {
  ...
  const deleteSurrender= (id) => {
    axios
      .delete(`http://localhost:3001/surrender/${id}`)
      .then(response => {
            ...
            {currentItems.map((surrender) => (
              <tr key={surrender.id} className='border-t hover:bg-blue-dark hover:text-white rounded-lg'>
                ...
                <div className='flex flex-row justify-center items-center'>
                  ...
                  <button className=' mr-2 p-1 rounded-full hover:bg-blue' onClick={() => { openAddModal(surrender.id);  }}  >
                    <DoneIcon/>
                  </button>
                  <button className='p-1 rounded-full hover:bg-red' onClick={() => {openDeleteModal(surrender.id); }}>
                    <DeleteIcon/>
                  </button>
                      ...
                      >
                        <form action="" className='flex flex-col justify-center items-center w-full'>
                          ...
                          <div className='w-full flex flex-row justify-end items-center p-4'>
                              ...
                              <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { addSurrender();  closeAddModal(); deleteSurrender(addModalSurrenderId) }}>
                                <p>Yes</p>
                              </button>
                    ...
                    >
                      <form action="" className='flex flex-col justify-center items-center w-full'>
                        ...
                        <div className='w-full flex flex-row justify-end items-center p-4'>
                          ...
                          <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue'
                              onClick={() => { deleteSurrender(deleteModalSurrenderId); closeDeleteModal(); }}
                          >
                            <p>Yes</p>
                          </button>
