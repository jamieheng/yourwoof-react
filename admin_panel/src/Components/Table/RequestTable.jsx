...
const RequestTable = () => {
  ...
  const addUserRequest = (id) => {
    if (selectedUser) {
      ...
      axios.post('http://localhost:3001/user', newUserWithoutId)
        .then(response => {
  ...
  const deleteUserRequest = (id) => {
    axios
      .delete(`http://localhost:3001/userRequest/${id}`)
      .then(response => {
              ...
              <tr key={userRequest.id} className='border-t hover:bg-blue-dark hover:text-white rounded-lg'>
                ...
                <td className='p-2 text-center'>
                  <div className='flex flex-row justify-center items-center'>
                      <button className=' mr-2 p-1 rounded-full hover:bg-blue' onClick={() => { openAddModal(userRequest.id); setNewUserData(userRequest); }} >
                         <DoneIcon/>
                      </button>
                      <button className='p-1 rounded-full hover:bg-red' onClick={() => {openDeleteModal(userRequest.id); }}>
                          <DeleteIcon/>
                      </button>
                  ...
                  >
                    <form action="" className='flex flex-col justify-center items-center w-full'>
                      ...
                      <div className='w-full flex flex-row justify-end items-center p-4'>
                          ...
                          <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { addUserRequest(addModalUserId); closeAddModal(); }}>
                            <p>Yes</p>
                          </button>
                  ...
                  >
                    <form action="" className='flex flex-col justify-center items-center w-full'>
                      ...
                      <div className='w-full flex flex-row justify-end items-center p-4'>
                            ...
                            <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { deleteUserRequest(deleteModalUserId); closeDeleteModal(); }}>
                              <p>Yes</p>
                            </button>
