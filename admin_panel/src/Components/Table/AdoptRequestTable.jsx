...
const AdoptRequestTable = () => {
  ...
  const addAdoptionRequest = (id) => {
    if (selectedAdoption) {
      ...
      axios.post('http://localhost:3001/adoption', newAdoptionWithoutId)
        .then(response => {
          // Delete the pet using petId
          axios.delete(`http://localhost:3001/pet/${petId}`)
            .then(() => {
  ...
  const deleteAdoptionRequest = (id) => {
    axios
      .delete(`http://localhost:3001/adoptionRequest/${id}`)
      .then(response => {
                ...
                <tr key={user.id} className='border-t hover:bg-blue-dark hover:text-white rounded-lg'>
                  ...
                  <td className='p-2 text-center'>
                    <div className='flex flex-row justify-center items-center'>
                      <button className=' mr-2 p-1 rounded-full hover:bg-blue' onClick={() => { openAddModal(user.id); setNewAdoptionData(user); }} >
                          <DoneIcon/>
                        </button>
                        <button className='p-1 rounded-full hover:bg-red' onClick={() => {openDeleteModal(user.id); }}>
                            <DeleteIcon/>
                      </button>
                      ...
                      >
                        <form action="" className='flex flex-col justify-center items-center w-full'>
                          ...
                          <div className='w-full flex flex-row justify-end items-center p-4'>
                              ...
                              <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { addAdoptionRequest(addModalAdoptionId); closeAddModal(); }}>
                                <p>Yes</p>
                              </button>
                      ...
                      >
                        <form action="" className='flex flex-col justify-center items-center w-full'>
                          ...
                          <div className='w-full flex flex-row justify-end items-center p-4'>
                                ...
                                <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { deleteAdoptionRequest(deleteModalAdoptionId); closeDeleteModal(); }}>
                                  <p>Yes</p>
                                </button>
