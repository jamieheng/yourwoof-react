...
const PetTable = () => {
  ...
  const [message, setMessage] = useState('');
	...
	const onHandleChange = async(e) =>{
		...
		try{
			const date= new Date()
			const imagePath = storage.ref(
				`/images/${file.name}-${date.getTime().toString()}-${Math.random()}`
			  );
			  setIsPending(true)
...
const addPet = () => {
  ...
  axios.post('http://localhost:3001/pet', newPet)
    .then(response => {
...
const editPet = (id) => {
  ...
  axios.put(`http://localhost:3001/pet/${id}`, updatedPet)  // Use editModalPetId here
    .then(response => {
...
const deletePet = (id) => {
  axios
    .delete(`http://localhost:3001/pet/${id}`)
    .then(response => {
...
<div className="sidebar m-4 w-full flex flex-col md:flex-row lg:flex-row justify-start lg:justify-between items-start overflow-x-auto">
            ...
            {currentItems.map(pets => (
              <tr key={pets.id} className='border-t hover:bg-blue-dark hover:text-white rounded-lg'>
                ...
                <div className='flex flex-row justify-center items-center'>
                    ...
                    <button className='p-1 rounded-full hover:bg-red'  onClick={() => {openDeleteModal(pets.id); }}>
                      <DeleteIcon/>
                    </button>
                    ...
                    >
                      ...
                      <div className='w-full flex flex-row justify-center items-center p-4'>
                        ...
                        <div className='text-blue-dark p-2 w-1/2 text-start'>
                          ...
                          <input type="text" value={petAge} onChange={(e) => setPetAge(e.target.value)} className='w-full p-4 items-center border-sm outline-none border border-blue-dark rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white'/>
                        </div>


                        <div className='text-blue-dark p-2 w-1/2 text-start'>
                          <p className='mb-2 font-bold'>Update Breed</p>
                          <input type="text" value={petBreed} onChange={(e) => setPetBreed(e.target.value)} className='w-full p-4 items-center border-sm outline-none border border-blue-dark rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white'/>
                        </div>

                        <div className='text-blue-dark p-2 w-1/2 text-start'>
                          <p className='mb-2 font-bold'>Update Description</p>
                          <textarea type="text" value={petDesc} onChange={(e) => setPetDesc(e.target.value)} className='w-full p-4 items-center border-sm outline-none border border-blue-dark rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white'/>
                        </div>

                        <div className='text-blue-dark p-2 w-1/2 text-start'>
                          <p className='mb-2 font-bold'>Update Medical Status</p>
                          <input type="text" value={petMedi} onChange={(e) => setPetMedi(e.target.value)} className='w-full p-4 items-center border-sm outline-none border border-blue-dark rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white'/>
                        </div>
                        ...
                        <div className='w-full flex flex-row justify-end items-center p-4'>
                              ...
                              <button
                                ...
                                onClick={() => {editPet(editModalPetId); closeEditModal()}}
                              >
                                <p>Save Changes</p>
                              </button>
                    ...
                    >
                      <form action="" className='flex flex-col justify-center items-center w-full'>
                        ...
                        <div className='w-full flex flex-row justify-end items-center p-4'>
                              ...
                              <button className='p-2 px-4 rounded-md bg-blue-dark rounded-full hover:bg-blue' onClick={() => { deletePet(deleteModalPetId); closeDeleteModal(); }}>
                                <p>Yes</p>
                              </button>
      ...
      <div className="sidebar m-4 w-full text-right flex flex-row justify-between items-center">
        ...
        <button className='bg-purple text-white hover:bg-blue-dark p-2 px-4 rounded-lg flex flex-row items-center text-right' onClick={openAddModal}>
            <AddIcon/>
                    ...
                    >
                      ...
                      <div className='w-1/2'>
                          <div className='text-blue-dark p-2 w-full text-start'>
                            ...
                            <div type="text" placeholder='Name' className='w-full p-4 items-center border-sm outline-none border border-blue-dark rounded-lg bg-blue-dark text-white '>
                              <p>Auto Generate</p>
                            </div>
                          </div>
                          ...
                          <div className='text-blue-dark p-2 w-full text-start'>
                            ...
                            <input type="text" placeholder='Name' name='petName'
                              onChange={handleInputChange} value={petName} className={`w-full p-4 items-center border-sm outline-none border ${isInvalidName ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}/>
                          ...
                          <div className='text-blue-dark p-2 w-full text-start'>
                            ...
                            <select
                              ...
                              value={petGender}
                              className={`w-full p-4 items-center border-sm outline-none border ${isInvalidGender ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}
                            >
                              <option value='' disabled>Select Gender</option>
                              <option value='Male'>Male</option>
                              <option value='Female'>Female</option>
                          ...
                          <div className='text-blue-dark p-2 w-full text-start'>
                            ...
                            <input keyboardType="numeric" placeholder='Age' name='petAge' onChange={handleInputChange} value={petAge} className={`w-full p-4 items-center border-sm outline-none border ${isInvalidAge ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}/>
                            {isInvalidAge && <p className='text-red text-left mt-2'>Please enter a pet age *</p>}
                          </div>

                          <div className='text-blue-dark p-2 w-full text-start'>
                            <p className='mb-2 font-bold'>Pet Breed</p>
                            <input type="text" placeholder='Breed' name='petBreed' onChange={handleInputChange} value={petBreed} className={`w-full p-4 items-center border-sm outline-none border ${isInvalidBreed ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}/>
                      ...
                      <div className='w-1/2'>
                        ...
                        <div className='text-blue-dark p-2 w-full text-start'>
                          ...
                          <input type="text" placeholder='Medical Status' name='petMedi' onChange={handleInputChange} value={petMedi} className={`w-full p-4 items-center border-sm outline-none border ${isInvalidMedi ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}/>
                        ...
                        <div className='text-blue-dark p-2 w-full text-start'>
                          ...
                          <textarea type="text" placeholder='Description' name='petDesc' onChange={handleInputChange} value={petDesc} className={`w-full p-4 items-center border-sm outline-none border ${isInvalidDesc ? 'border-red' : 'border-blue-dark'} rounded-lg focus:bg-blue-dark focus:text-white hover:bg-blue-dark hover:text-white`}/>
